...
public:
    StockTrading(string modeinput, uint32_t numberofstock, uint32_t numoftrad) : mode_for_stocks(modeinput), trades_completed(0), num_traders(numoftrad), num_stocks(numberofstock) {
